...
layout = html.Div(
    [        
        ...
        html.Div([
            ...
            style={'margin-top': '20',"padding":"10px"}
        ),
        html.Div([
                html.Table([
                    html.Tr([
...
def make_main_figure(well_statuses, well_types, year_slider,
    ...
    #_main_graph_layout = copy.deepcopy(graph_layout)
    dff = filter_dataframe(df, well_statuses, well_types, year_slider)
    #print(dff)
    traces = []
...
def make_individual_figure(main_graph_hover):
    ...
    layout_individual = copy.deepcopy(graph_layout)
...
def make_aggregate_figure(well_statuses, well_types, year_slider,
    ...
    layout_aggregate = copy.deepcopy(graph_layout)
...
def make_pie_figure(well_statuses, well_types, year_slider):
    ...
    layout_pie = copy.deepcopy(graph_layout)
...
def make_count_figure(well_statuses, well_types, year_slider):
    ...
    layout_count = copy.deepcopy(graph_layout)
